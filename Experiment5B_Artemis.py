    ...
    for r in range(repeats):
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), weightsDir / Path(f'best_forward_exp5B.pkl'))
        ...
        model.load_state_dict(torch.load(weightsDir / Path(f'best_forward_exp5B.pkl'), map_location=device))

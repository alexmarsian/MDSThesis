...
# Sparse, Cifar100, No Noise, Peer Loss
dataset = "cifar100"
noise_rate = 0.0
noise_mode="sym"
batch_size=128
...
sparsity = 0.8
weightFileName = f"R34_Cifar100_peerSparse_{int(noise_rate*100)}pct_{noise_mode}"
repeats = 3
...
# Sparse, Cifar100, 20% symmetric noise, Peer Loss
noise_rate = 0.2
...
# Sparse, Cifar100, 30% symmetric noise, Peer Loss
noise_rate = 0.3
...
# Sparse, Cifar100, 40% symmetric noise, Peer Loss
noise_rate = 0.4
...
# Sparse, Cifar100, 50% symmetric noise, Peer Loss
noise_rate = 0.5
...
# Sparse, Cifar100, 80% symmetric noise, Peer Loss
noise_rate = 0.8
...
# Sparse, Cifar100, 90% symmetric noise, Peer Loss
noise_rate = 0.9
...
# Sparse, Cifar100, 40% asymmetric noise, Peer Loss
noise_rate = 0.4
noise_mode="asym"

...
# Dense, Cifar100, No Noise, Peer Loss
dataset = "cifar100"
noise_rate = 0.0
noise_mode="sym"
batch_size=128
...
sparsity = 0.0
weightFileName = f"R34_Cifar100_peer_{int(noise_rate*100)}pct_{noise_mode}"
repeats = 3
...
# Dense, Cifar100, 20% symmetric noise, Peer Loss
noise_rate = 0.2
...
# Dense, Cifar100, 30% symmetric noise, Peer Loss
noise_rate = 0.3
...
# Dense, Cifar100, 40% symmetric noise, Peer Loss
noise_rate = 0.4
...
# Dense, Cifar100, 50% symmetric noise, Peer Loss
noise_rate = 0.5
...
# Dense, Cifar100, 80% symmetric noise, Peer Loss
noise_rate = 0.8
...
# Dense, Cifar100, 90% symmetric noise, Peer Loss
noise_rate = 0.9
...
# Dense, Cifar100, 40% asymmetric noise, Peer Loss
noise_rate = 0.4
noise_mode="asym"
...
# Dense, Cifar10, human noise, Peer Loss
noise_rate = 0.0
noise_mode="human"

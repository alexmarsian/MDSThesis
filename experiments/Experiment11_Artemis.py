...
# RigL, 20% Density, CIFAR100 with 20% Symmetric Noise
dataset = "cifar100"
noise_rate = 0.2
noise_mode="sym"
batch_size=128
...
# RigL, 20% Density, CIFAR100 with 30% Symmetric Noise
...
# RigL, 20% Density, CIFAR100 with 40% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.4
...
# RigL, 20% Density, CIFAR100 with 50% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.5
...
# RigL, 20% Density, CIFAR100 with 80% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.8
...
# RigL, 20% Density, CIFAR100 with 90% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.9

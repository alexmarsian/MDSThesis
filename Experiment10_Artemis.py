...
# these are settings for training RigL
...
# RigL, 20% Density, CIFAR10 with 20% Symmetric Noise
dataset = "cifar10"
noise_rate = 0.2
noise_mode="sym"
batch_size=128
...
# RigL, 20% Density, CIFAR10 with 30% Symmetric Noise
...
# RigL, 20% Density, CIFAR10 with 40% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.4
...
# RigL, 20% Density, CIFAR10 with 50% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.5
...
# RigL, 20% Density, CIFAR10 with 80% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.8
...
# RigL, 20% Density, CIFAR10 with 90% Symmetric Noise
# Only relevant parameters changed
noise_rate = 0.9
...
# RigL, 20% Density, CIFAR10 with 40% asymmetric Noise
noise_rate = 0.4
noise_mode="asym"

...
# Dense, Cifar10, No Noise, Peer Loss
dataset = "cifar10"
noise_rate = 0.0
noise_mode="sym"
batch_size=128
...
sparsity = 0.0
weightFileName = f"R18_Cifar10_peer_{int(noise_rate*100)}pct_{noise_mode}"
repeats = 3
...
# Dense, Cifar10, 20% symmetric noise, Peer Loss
noise_rate = 0.2
...
# Dense, Cifar10, 30% symmetric noise, Peer Loss
noise_rate = 0.3
...
# Dense, Cifar10, 40% symmetric noise, Peer Loss
noise_rate = 0.4
...
# Dense, Cifar10, 50% symmetric noise, Peer Loss
noise_rate = 0.5
...
# Dense, Cifar10, 80% symmetric noise, Peer Loss
noise_rate = 0.8
...
# Dense, Cifar10, 90% symmetric noise, Peer Loss
noise_rate = 0.9
...
# Dense, Cifar10, 40% asymmetric noise, Peer Loss
noise_rate = 0.4
noise_mode="asym"
